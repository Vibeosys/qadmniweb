...
/**
 * CustomerFavoritesFixture
 *
 */
class CustomerFavoritesFixture extends TestFixture
{
    ...
    public $fields = [
        'FavId' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['FavId'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
